...
class Config_EPA:
    def __init__(self):
        # 训练参数
        self.num_classes = 5  # 修改为16个ID类别
        self.feature_dim = 512
        self.epochs = 100       # 增加训练轮次
        self.batch_size = 128
        # 路径参数
        self.save_dir = "results/rml201610a_comix_ood_qam16_8psk"
        self.device = device
        # 配置文件
        self.config_files = [
            './configs/datasets/rml201610a_comix/rml201610a_comix_ood_qam16_8psk.yml',
            './configs/datasets/rml201610a_comix/rml201610a_comix_ood_qam16_8psk_ood.yml',
